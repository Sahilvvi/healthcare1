...
-- Link public doctor profiles to auth accounts for role-based dashboards
ALTER TABLE public.dv_doctors ADD COLUMN IF NOT EXISTS user_id uuid;

-- Prescriptions written by doctors for patients
...
-- Support tickets for patients and platform staff
...
-- Financial transactions: income, cost and refunds
